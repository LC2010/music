...
class ItemController extends DefaultController {
    ...
    public function get() {
        ...
        $row ? Message::showSucc('获取单条图片数据', $row) : Message::showError('没有获取到指定数据，可能已被删除', $row);
    }
    ...
    public function update() {
        ...
        //更新提示
        $rs ? Message::showSucc('更新成功', $changeNewRow) : Message::showError('更新失败：' . implode(" ", $itemDB->getErrorInfo()));
    }
