...
//*******************************************************应用名称********************************************************
defined('DAGGER_APP_HOPE')  || define('DAGGER_APP_HOPE', 'hope');
defined('DAGGER_APP_HOME')  || define('DAGGER_APP_HOME', 'home');
...
if (DAGGER_PLATFORM == 'sae') {
    ...
    defined('DAGGER_PATH_DATA')     || define('DAGGER_PATH_DATA',           DAGGER_APP_DATA );//数据目录,格式：/data1/apache/data
    defined('DAGGER_PATH_CACHE')    || define('DAGGER_PATH_CACHE',          DAGGER_APP_CACHE );//缓存目录,格式：/data1/apache/cache
    defined('DAGGER_PATH_APPLOG')   || define('DAGGER_PATH_APPLOG',         DAGGER_APP_APPLOGS );//缓存目录,格式：/data1/apache/applogs
}

//*******************************************************模板引擎******************************************************
defined('DAGGER_TEMPLATE_ENGINE')   || define('DAGGER_TEMPLATE_ENGINE',     'default');//默认不使用模版引擎,使用smarty时值为：smarty
...
defined('DAGGER_CONTROLLER')        || define('DAGGER_CONTROLLER','s');
